              ...
              items: [
                {
                  ...
                  'description': 'Ringkasan akumulasi nilai formatif dan sumatif siswa dalam satu periode semester.',
                ...
                },
                {
                  ...
                  'description': 'Persentase kehadiran dan rekapitulasi ketidakhadiran siswa per bulan.',
                    ...
                    MaterialPageRoute(
                      builder: (context) => BlocProvider(
                        create: (context) {
                          ...
                          final repository = LaporanRepositoryImpl(localDatasource: dataSource);
                          return LaporanBloc(
                            getStudentNilaiUsecase: GetStudentNilaiUsecase(repository),
                            getTotalSiswaUsecase: GetTotalSiswaUsecase(repository),
                          );
                        },
                    ...
                    MaterialPageRoute(
                      builder: (context) => BlocProvider(
                        create: (context) {
                          ...
                          final repo = LaporanAbsensiRepositoryImpl(localDatasource: ds);
                          return LaporanAbsensiBloc(
                            getStudentAttendanceUsecase: GetStudentAttendanceUsecase(repo),
                            getTotalStudentsUsecase: GetTotalStudentsUsecase(repo),
                          );
                        },
